...
export const PersonalDataSection: React.FC<PersonalDataSectionProps> = ({
  ...
  return (
    <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
      ...
      {/* Seção de Dados Pessoais Básicos */}
      <div className="mb-8">
        <h4 className="text-lg font-medium text-gray-700 mb-4">Informações Pessoais</h4>
      ...
      {/* Seção de Endereço */}
      <div>
        <h4 className="text-lg font-medium text-gray-700 mb-4">Endereço</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField
            control={control}
            name="cep"
