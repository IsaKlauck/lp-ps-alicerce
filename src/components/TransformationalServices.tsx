        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => 
            <div key={service.title} className="relative">
              <Card className="border-0 overflow-hidden bg-alicerce-orange text-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 rounded-3xl mt-12">
                <CardHeader className="pt-6 pb-4 text-center relative">
                  {/* Icon circle positioned inside the CardHeader */}
